...
const CardComponent = (props) => {
	...
	return (
      ...
      <CardContent>
        <Grid container rowGap={2} display={'flex'} justifyContent={'center'} flexDirection={'column'}>
			<Grid item>
				<Chip sx={{ textTransform: 'capitalize' }} label={priority} color="primary" />
			</Grid>
			<Grid item>
			...
			<Grid item xs={12}>
				<Button color="error" onClick={() => handleStatus(id, STATUS.DELETED)} variant="outlined" fullWidth startIcon={<DeleteIcon color='error'/>}>
					Delete
				</Button>
			</Grid>
		</Grid>
