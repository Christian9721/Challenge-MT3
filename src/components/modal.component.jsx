			...
			<Grid container rowGap={4}>
				...
				<Field label="Priority">
					<Select
						...
						>
						<MenuItem sx={{ textTransform: 'capitalize' }} value={PRIORITIES.HIGH}>{PRIORITIES.HIGH}</MenuItem>
						<MenuItem sx={{ textTransform: 'capitalize' }} value={PRIORITIES.MEDIUM}>{PRIORITIES.MEDIUM}</MenuItem>
						<MenuItem sx={{ textTransform: 'capitalize' }} value={PRIORITIES.LOW}>{PRIORITIES.LOW}</MenuItem>
					</Select>
				</Field>
				<Field label="Text">
				...
				<Button variant="contained" color="primary" onClick={handleSendData}>ADD</Button>
			</Grid>
        </Box>
      </Modal>
	)
